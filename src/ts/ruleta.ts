...
function esperarTransicion(el: Element): Promise<void> {
...
// ------ GIROS MÚLTIPLES ------
//
async function girarVariasVeces(cantidad: number) {
  ...
  if (giros > 0) girarBtn.removeAttribute("disabled");
